        ...
        <div class="footer-body">
            <ul class="left-panel list-inline mb-0 p-0">
              @if(env('DISPLAY_FOOTER') === true)
                ...
                @if(env('DISPLAY_FOOTER_CONTACT') === true)<li class="list-inline-item"><a class="footer-hover spacing" href="https://amplifydigital.freshdesk.com/support/tickets/new?ticket_form=onelink_support" target="_blank">{{footer('Contact')}}</a></li>@endif
              @endif                     
            </ul>
