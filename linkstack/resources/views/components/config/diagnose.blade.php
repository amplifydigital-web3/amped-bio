...
$wrt2 = is_writable(base_path('database/onelink.sqlite'));

//Files or directories to test if accessible externally
$url1 = getUrlSatusCode(url('.env'));
$url2 = getUrlSatusCode(url('database/onelink.sqlite'));
...
?>
        ...
        <tbody>
          ...
          <tr>
            <td title="">{{ url('/database/onelink.sqlite') }}</td>
        ...
        <tbody>
          ...
          <tr>
            <td title="">{{ base_path("database/onelink.sqlite") }}</td>
