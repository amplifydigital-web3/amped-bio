...
@include('layouts.lang')
  <head>
    ...
    @php $GLOBALS['themeName'] = config('advanced-config.home_theme'); @endphp
      ...
      <meta http-equiv="Content-Security-Policy" content="frame-ancestors 'self' https://secure.walletconnect.org https://verify.walletconnect.org/">  
    ...
    <footer class="text-center mt-5">
        <ul class="mb-0 p-0 footer-content">
          @if(env('DISPLAY_FOOTER') === true)
            ...
            @if(env('DISPLAY_FOOTER_CONTACT') === true)<li class="list-inline-item"><a class="list-inline-item" href="https://npaymelabs.freshdesk.com/support/tickets/new?ticket_form=npayme_onelink_support" target="_blank">{{footer('Contact')}}</a></li>@endif
          @endif
        </ul>
        <div class="right-panel">
          ...
          @if(env('DISPLAY_CREDIT_FOOTER') === true)
            ...
            </span> {{__('messages.by')}} <a href="https://onelink.npayme.io/" target="_blank">OneLink</a>.
          @endif
        </div>
</footer>
