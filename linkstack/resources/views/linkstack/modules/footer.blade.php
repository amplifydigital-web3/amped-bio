<div class="container">
	...
	@if(env('DISPLAY_FOOTER') === true)
		...
		@if(env('DISPLAY_FOOTER_CONTACT') === true)<a class="footer-hover spacing" href="https://npaymelabs.freshdesk.com/support/tickets/new?ticket_form=npayme_onelink_support">{{footer('Contact')}}</a>@endif
	@endif
	</div>
