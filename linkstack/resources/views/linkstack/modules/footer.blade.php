<div class="container">
	...
	@if(env('DISPLAY_FOOTER') === true)
		...
		@if(env('DISPLAY_FOOTER_CONTACT') === true)<a class="footer-hover spacing" href="https://amplifydigital.freshdesk.com/support/tickets/new?ticket_form=onelink_support" target="_blank">{{footer('Contact')}}</a>@endif
	@endif
	</div>
