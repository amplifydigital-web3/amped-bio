            ...
            <div class="card card-transparent auth-card shadow-none d-flex mb-0">
              <div class="card-body justify-content-center text-center">
                ...
                <div class="logo-container fadein">
                  <img src="{{ asset('assets/linkstack/images/amplify.svg') }}" alt="Logo" style="width:150px; height:150px;">
                </div>
            ...
            <div class="footer-body">
                <ul class="left-panel list-inline mb-0 p-0">
                  @if(env('DISPLAY_FOOTER') === true)
                    ...
                    @if(env('DISPLAY_FOOTER_CONTACT') === true)<li class="list-inline-item"><a class="list-inline-item" href="https://amplifydigital.freshdesk.com/support/tickets/new?ticket_form=amped-bio_support" target="_blank">{{footer('Contact')}}</a></li>@endif
                  @endif
                </ul>
                <div class="right-panel">
                  ...
                  @if(env('DISPLAY_CREDIT_FOOTER') === true)
                    ...
                    </span> {{__('messages.by')}} <a href="https://amped.bio" target="_blank">Amped-Bio</a>.
                  @endif
                </div>
            </div>
        </footer>
